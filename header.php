    ...
    <div id="container" class="container">
        ...
        <div id="header" class=" ">
            <div class="row">
                ...
                <div class="large-7 small-12 columns main-nav">
                    ...
                    <div class="contain-to-grid <?php if ($smof_data['pkb_sticky_nav'] == 1) {
                        ...
                        <nav class="top-bar" data-topbar>
                            ...
                            <section class="top-bar-section">
                                ...
                                ?>
                                <?php include get_template_directory() . '/incl/social-toolbox.php'; ?>
        ...
        <?php if (is_page_template('page-home.php')) {
            if ($smof_data['pkb_slide_type'] == 'orbit') {
                include get_template_directory() . '/incl/slide-home.php'; // Orbit slider
            } else {
                include get_template_directory() .  '/incl/slide-flexslider.php'; // Flexslider
            }
        } // Get slide if it is Home Page ?>
        <?php if (is_page_template('page-home.php')) {
            include get_template_directory() .  '/incl/quick-menu.php';
        } // Get slide if it is Home Page ?>